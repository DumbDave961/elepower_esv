...
ele.external.ing.lead_ingot = "elepower_dynamics:lead_block"
ele.external.ing.lead_block = "elepower_dynamics:lead_block"
ele.external.ing.lead_dust  = "elepower_nuclear:lead_dust"
ele.external.ing.zinc_lump  = "elepower_dynamics:zinc_lump"  --technic also has zinc
ele.external.ing.zinc_ingot = "elepower_dynamics:zinc_block"
